...
function get20s(arr){
  ...
  for (i = 0; i < arr.length; i++) {
    ...
    if (arr[i].years.substring(0, 4) >= 1900 && arr[i].years.slice(-4) <= 2000) {
...
addArtist(20, "Pedro Casuso", "1998 - 2020", "Web Design", "Peruvian", "Lorem Ipsum dolor sit amet. I am the greatest artist there ever was.");
