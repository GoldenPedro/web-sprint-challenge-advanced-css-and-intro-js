...
2. Talk about 3 different things you can do to ensure your website is accessible. 
    ...
    Be aware of use of colors for people with color-blindness
    Use appropriate html for people that use screen-readers

3. How would you explain the concept of a variable to someone new to programming?
    A variable is a container where we can store information to be used later on. We can also change the information stored in it.

4. What is the purpose of using functions in code?
    To have reusable code that follows a certain logic whenever we invoke it. 
